...
//        Mat testImage = imread(args[1], CV_LOAD_IMAGE_GRAYSCALE);
        String trainingDir = "data\\face_train";
        Mat testImage = imread("data\\face_predict\\1-9.bmp", CV_LOAD_IMAGE_GRAYSCALE);
//        Mat testImage = imread("data\\face_predict\\2-8.bmp", CV_LOAD_IMAGE_GRAYSCALE);
        ...
        System.out.println("Predicted label: " + label.get(0));
